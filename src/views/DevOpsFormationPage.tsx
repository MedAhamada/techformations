...
// import InscriptionForm from '../components/ui/InscriptionForm'; // hidden — form replaced by WhatsApp CTA
      ...
      <section className="py-20 bg-dark-800/30 border-y border-white/5" id="inscription">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-12">
            {/* Left: info */}
            <SectionWrapper className="lg:col-span-2 lg:col-start-1">
            ...
            {/* Right: WhatsApp CTA — form hidden while email service is unavailable */}
            ...
            <SectionWrapper className="lg:col-span-3">
              <div className="glass rounded-2xl border border-white/10 p-8 flex flex-col items-center text-center gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-2">Inscrivez-vous via WhatsApp</h3>
                  <p className="text-slate-400 leading-relaxed max-w-sm mx-auto">
                    Envoyez-nous un message sur WhatsApp pour réserver votre place. Notre équipe vous répond sous 24h avec les détails de la session.
                  </p>
                </div>
                <a
                  href="https://wa.me/33756850927?text=Bonjour%2C%20je%20souhaite%20m'inscrire%20%C3%A0%20la%20formation%20DevOps%20pour%20d%C3%A9veloppeurs."
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-green-500 hover:bg-green-400 text-white font-bold text-base transition-all duration-200 shadow-lg shadow-green-500/20"
                >
                ...
                <p className="text-slate-500 text-sm">+33 7 56 85 09 27 · Lun–Ven, 9h–18h</p>
              </div>
            </SectionWrapper>
          </div>
        </div>
