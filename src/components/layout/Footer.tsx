...
export default function Footer() {
  ...
  const links = {
    Formations: [
      { label: 'DevOps pour développeurs', href: '/formations/devops-pour-developpeurs' },
      { label: 'Catalogue complet', href: '/formations' },
      { label: 'Prochainement', href: '/formations' },
    ],
    Plateforme: [
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-wrap gap-2">
              {technologies.map(tech => (
                <span
                  key={tech}
                  className="px-2 py-1 text-xs font-medium text-slate-500 bg-white/5 rounded border border-white/5"
                >
                  {tech}
                </span>
              ))}
