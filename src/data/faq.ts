...
export const faqDevops: FAQ[] = [
  {
    question: 'Est-ce que cette formation est faite pour moi si je débute en DevOps ?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Vous devez avoir des bases en développement web (n\'importe quel langage : JavaScript, Python, PHP, etc.). Une connaissance basique de la ligne de commande est un plus mais pas obligatoire. Tout est expliqué progressivement.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Cette formation est orientée terrain, pas théorique. Chaque concept est appliqué immédiatement sur un vrai projet. Le niveau de détail et la cohérence du parcours vont bien au-delà de ce qu\'on trouve sur des plateformes génériques. De plus, vous avez accès au formateur et à la communauté.',
  },
];

export const faqGeneral: FAQ[] = [
  {
    question: 'La plateforme est-elle adaptée aux débutants ?',
    answer:
      'Oui. Nos formations sont conçues pour les développeurs à tous les niveaux. Certaines formations sont pour débutants DevOps, d\'autres nécessitent des prérequis. Chaque formation indique clairement son niveau.',
  },
  {
    question: 'Comment accéder aux formations après l\'achat ?',
    answer:
      'Après votre achat, vous recevez un email de confirmation avec vos identifiants d\'accès. Vous pouvez accéder immédiatement à l\'espace apprenant et commencer la formation.',
  },
  {
